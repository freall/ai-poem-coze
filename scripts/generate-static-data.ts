...
/**
 * 静态数据生成脚本
 * 将诗词数据生成为静态JSON文件，支持纯前端部署
 */

import { parsePoemsFromContent, getPoemsByCategory, RawPoemData } from '../src/lib/poem-parser';
...
56. 《清明夜》（唐·白居易）—— 好风胧月清明夜，共女同郎照灼然。直至画楼人不见，不思归去作闲仙。

57. 《江城子·乙卯正月二十日夜记梦》（宋·苏轼）—— 十年生死两茫茫，不思量，自难忘。千里孤坟，无处话凄凉。纵使相逢应不识，尘满面，鬓如霜。

### 4. 端午节（6首）

56. 《端午》（唐·文秀）—— 节分端午自谁言，万古传闻为屈原。堪笑楚江空渺渺，不能洗得直臣冤。

57. 《竞渡诗》（唐·卢肇）—— 石溪久住思端午，馆驿楼前看发机。鼙鼓动时雷隐隐，兽头凌处雪微微。冲波突出人齐譀，跃浪争先鸟退飞。向道是龙刚不信，果然夺得锦标归。

58. 《乙卯重五诗》（宋·陆游）—— 重五山村好，榴花忽已繁。粽包分两髻，艾束著危冠。旧俗方储药，羸躯亦点丹。日斜吾事毕，一笑向杯盘。

59. 《端午日》（唐·殷尧藩）—— 少年佳节倍多情，老去谁知感慨生。不效艾符趋习俗，但祈蒲酒话升平。鬓丝日日添白头，榴锦年年照眼明。千载贤愚同瞬息，几人湮没几垂名。

60. 《和端午》（宋·张耒）—— 竞渡深悲千载冤，忠魂一去讵能还。国亡身殒今何有，只留离骚在世间。

61. 《浣溪沙·端午》（宋·苏轼）—— 轻汗微微透碧纨，明朝端午浴芳兰。流香涨腻满晴川。彩线轻缠红玉臂，小符斜挂绿云鬟。佳人相见一千年。

### 5. 七夕节（5首）

62. 《乞巧》（唐·林杰）—— 七夕今宵看碧霄，牵牛织女渡河桥。家家乞巧望秋月，穿尽红丝几万条。

63. 《迢迢牵牛星》（汉·佚名）—— 迢迢牵牛星，皎皎河汉女。纤纤擢素手，札札弄机杼。终日不成章，泣涕零如雨。河汉清且浅，相去复几许？盈盈一水间，脉脉不得语。

64. 《七夕》（唐·罗隐）—— 络角星河菡萏天，一家欢笑设红筵。应倾谢女珠玑箧，尽写檀郎锦绣篇。香帐簇成排窈窕，金针穿罢拜婵娟。铜壶漏报天将晓，惆怅佳期又一年。

65. 《鹊桥仙·纤云弄巧》（宋·秦观）—— 纤云弄巧，飞星传恨，银汉迢迢暗度。金风玉露一相逢，便胜却人间无数。柔情似水，佳期如梦，忍顾鹊桥归路。两情若是久长时，又岂在朝朝暮暮。

66. 《秋夕》（唐·杜牧）—— 银烛秋光冷画屏，轻罗小扇扑流萤。天阶夜色凉如水，坐看牵牛织女星。

### 6. 中秋节（5首）

67. 《十五夜望月》（唐·王建）—— 中庭地白树栖鸦，冷露无声湿桂花。今夜月明人尽望，不知秋思落谁家。

68. 《水调歌头·明月几时有》（宋·苏轼）—— 明月几时有？把酒问青天。不知天上宫阙，今夕是何年。我欲乘风归去，又恐琼楼玉宇，高处不胜寒。起舞弄清影，何似在人间。转朱阁，低绮户，照无眠。不应有恨，何事长向别时圆？人有悲欢离合，月有阴晴圆缺，此事古难全。但愿人长久，千里共婵娟。

69. 《中秋月》（宋·晏殊）—— 十轮霜影转庭梧，此夕羁人独向隅。未必素娥无怅恨，玉蟾清冷桂花孤。

70. 《望月怀远》（唐·张九龄）—— 海上生明月，天涯共此时。情人怨遥夜，竟夕起相思。灭烛怜光满，披衣觉露滋。不堪盈手赠，还寝梦佳期。

71. 《中秋》（唐·司空图）—— 闲吟秋景外，万事觉悠悠。此夜若无月，一年虚过秋。

### 7. 重阳节（4首）

72. 《九月九日忆山东兄弟》（唐·王维）—— 独在异乡为异客，每逢佳节倍思亲。遥知兄弟登高处，遍插茱萸少一人。

73. 《醉花阴·薄雾浓云愁永昼》（宋·李清照）—— 薄雾浓云愁永昼，瑞脑销金兽。佳节又重阳，玉枕纱厨，半夜凉初透。东篱把酒黄昏后，有暗香盈袖。莫道不销魂，帘卷西风，人比黄花瘦。

74. 《采桑子·重阳》（宋·毛泽东）—— 人生易老天难老，岁岁重阳。今又重阳，战地黄花分外香。一年一度秋风劲，不似春光。胜似春光，寥廓江天万里霜。

75. 《九月九日登玄武山》（唐·卢照邻）—— 九月九日眺山川，归心归望积风烟。他乡共酌金花酒，万里同悲鸿雁天。

### 8. 除夕（3首）

76. 《除夜》（唐·高适）—— 旅馆寒灯独不眠，客心何事转凄然。故乡今夜思千里，霜鬓明朝又一年。

77. 《除夜雪》（宋·陆游）—— 北风吹雪四更初，嘉瑞天教及岁除。半盏屠苏犹未举，灯前小草写桃符。

78. 《守岁》（宋·苏轼）—— 欲知垂尽岁，有似赴壑蛇。修鳞半已没，去意谁能遮。儿童强不睡，相守夜欢哗。晨鸡且勿唱，更鼓畏添挝。坐久灯烬落，起看北斗斜。明年岂无年，心事恐蹉跎。努力尽今夕，少年犹可夸。`;

// 解析诗词数据
const poems = parsePoemsFromContent(poemContent);
const categories = getPoemsByCategory(poems);

console.log(`解析出 ${poems.length} 首诗词`);
...
// 确保目录存在
mkdirSync(dirname(join(outputDir, 'poems.json')), { recursive: true });

// 写入完整数据
writeFileSync(
  join(outputDir, 'poems.json'),
  JSON.stringify({
    total: poems.length,
    categories,
    poems,
...
console.log(`数据已导出到 ${join(outputDir, 'poems.json')}`);

// 分别写入每首诗词
poems.forEach(poem => {
  const fileName = `poem-${poem.number}.json`;
  writeFileSync(
...
console.log(`已生成 ${poems.length} 个独立诗词文件`);
